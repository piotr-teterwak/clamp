    ...
    def __init__(
        ...
        if config is None:
            ...
            if hasattr(self.config, "is_encoder_decoder") and self.config.is_encoder_decoder:
                ...
                self.transformer = create_func(model_args, output_hidden_states=True, torch_dtype='auto')
            else:
                self.transformer = create_func(model_args, add_pooling_layer=uses_transformer_pooler,output_hidden_states=True, torch_dtype='auto')
        else:
            self.config = config
